...
CREATE TABLE dispatch (
    ...
    raw_surge                   DOUBLE PRECISION,
    target_matching_rate        DOUBLE PRECISION,
    calculated_surge            DOUBLE PRECISION,
    final_surge                 DOUBLE PRECISION,
    final_fare_estimate_usd     DOUBLE PRECISION,
